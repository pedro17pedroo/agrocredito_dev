...
export async function seedApplications() {
  try {
    ...
    if (!farmer) {
      console.log(
        '❌ Utilizador agricultor não encontrado. Execute primeiro o seed principal.'
      );
      return;
    }
    ...
    const sampleApplications: InsertCreditApplication[] = [
      {
        ...
        projectType: 'corn',
        description:
          'Projeto para cultivo de 5 hectares de milho durante a época das chuvas. Incluí preparação do terreno, sementes melhoradas, fertilizantes e pesticidas. Expectativa de produção de 25 toneladas.',
        ...
        creditGuaranteeDeclaration:
          'Ofereço como garantia a hipoteca da propriedade agrícola de 8 hectares localizada na comuna do Kaculama, avaliada em AOA 1,200,000. Adicionalmente, disponibilizo o aval do Sr. António Manuel, comerciante na região.',
        // Campos financeiros
      ...
      },
      {
        ...
        projectType: 'cattle',
        description:
          'Aquisição de 10 cabeças de gado bovino para criação e reprodução. Inclui construção de curral, vacinação e alimentação para os primeiros 6 meses.',
        ...
        creditGuaranteeDeclaration:
          'Ofereço como garantia a hipoteca do terreno de 20 hectares com pastagens, localizado no município de Malanje, avaliado em AOA 4,000,000. Tenho também contrato de fornecimento com o frigorífico local como garantia adicional.',
        // Campos financeiros
      ...
      },
      {
        ...
        projectType: 'cassava',
        description:
          'Cultivo de 3 hectares de mandioca. Projeto inclui preparação do solo, mudas, ferramentas agrícolas e mão-de-obra para plantio e colheita.',
        ...
        creditDeliveryMethod: 'monthly',
        creditGuaranteeDeclaration:
          'Apresento como garantia o penhor de equipamentos agrícolas (trator e alfaias) avaliados em AOA 650,000, além do aval solidário da Cooperativa Agrícola de Malanje.',
        // Campos financeiros
      ...
      },
      {
        ...
        projectType: 'poultry',
        description:
          'Montagem de aviário para 200 galinhas poedeiras. Inclui construção do galinheiro, aquisição das aves, ração para os primeiros 3 meses e equipamentos.',
        ...
        creditDeliveryMethod: 'total',
        creditGuaranteeDeclaration:
          'Ofereço como garantia a hipoteca da propriedade onde será construído o aviário, avaliada em AOA 1,100,000, e contrato de fornecimento de ovos com mercados locais.',
        // Campos financeiros
      ...
      },
      {
        ...
        description:
          'Desenvolvimento de horta para produção de tomate, cebola, alface e pimento. Inclui sistema de irrigação, sementes, fertilizantes orgânicos e ferramentas.',
        ...
        creditDeliveryMethod: 'total',
        creditGuaranteeDeclaration:
          'Apresento como garantia equipamentos de irrigação e ferramentas agrícolas avaliados em AOA 400,000, além do aval do presidente da associação de agricultores locais.',
        // Campos financeiros
    ...
    for (const application of sampleApplications) {
      ...
      if (!existing) {
        ...
        console.log(
          `  ✅ Solicitação criada: ${application.projectName} (${application.status})`
        );
      } else {
